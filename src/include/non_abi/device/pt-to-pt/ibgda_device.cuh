...
__device__ NVSHMEMI_STATIC NVSHMEMI_DEVICE_ALWAYS_INLINE nvshmemi_ibgda_device_qp_t *ibgda_get_rc(
    ...
    bool is_backup;
    int qp_idx;
    return ibgda_get_rc_with_failover(pe, out_shared_among_ctas, &is_backup, &qp_idx);
}
...
__device__ NVSHMEMI_STATIC NVSHMEMI_DEVICE_ALWAYS_INLINE nvshmemi_ibgda_device_qp_t *ibgda_get_qp(
    ...
    bool is_backup;
    int qp_idx;
    return ibgda_get_qp_with_failover(pe, out_shared_among_ctas, &is_backup, &qp_idx);
}
